    ...
    try {
      ...
      if (permission == LocationPermission.deniedForever) {
        setState(() {
          ...
          _locationPermissionMessage = 'Location permission is permanently denied.';
        });
        return;
      }
  ...
  void _viewContacts() {
    if (_selectedFacility != null) {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => FacilityContactsPage(facility: _selectedFacility!),
        ),
      );
    }
  }
  ...
  Future<void> _seeDirections() async {
    if (_selectedFacility?.coordinates == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Unable to get directions: Facility location not available'),
